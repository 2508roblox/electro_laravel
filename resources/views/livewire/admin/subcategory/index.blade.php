                ...
                <div class="sa-toolbar__item dropdown"><button class="sa-toolbar__button" type="button"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton3">
                        <li><a class="dropdown-item d-flex align-items-center" href="#"><img
                                    src="vendor/flag-icons/24/DE.png" class="sa-language-icon me-3"
                                    alt="" /><span class="ps-2">German</span></a></li>
                        <li><a class="dropdown-item d-flex align-items-center" href="#"><img
                                    src="vendor/flag-icons/24/FR.png" class="sa-language-icon me-3"
                                    alt="" /><span class="ps-2">French</span></a></li>
                        <li><a class="dropdown-item d-flex align-items-center" href="#"><img
                                    src="vendor/flag-icons/24/GB.png" class="sa-language-icon me-3"
                                    alt="" /><span class="ps-2">English</span></a></li>
                        <li><a class="dropdown-item d-flex align-items-center" href="#"><img
                                    src="vendor/flag-icons/24/RU.png" class="sa-language-icon me-3"
                                    alt="" /><span class="ps-2">Russian</span></a></li>
                        <li><a class="dropdown-item d-flex align-items-center" href="#"><img
                ...
                <div class="container">
                    <div class="py-5">
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-auto d-flex"><a href="{{ route('admin.subcategory.create') }}"
                                    ...
                                    <tr>
                                        <td>
                                            <img width="100px" height="100px"
                                                src="{{ asset('storage/' . $subcategory->image) }}" alt="">
                                        </td>

                                        <td><a href="app-brand.html" class="text-reset">{{ $subcategory->name }}</a>
                                        </td>
                                        <td><a href="app-brand.html"
                                                class="text-reset">{{ $subcategory->category_id }}</a></td>
                                        <td>3</td>
                                        <td>
                                            <div class="badge badge-sa-success">
                                                {{ $subcategory->status == '1' ? 'Publish' : 'Hidden' }}</div>
                                        </td>
                                        <td>
                                            <div class="dropdown"><button class="btn btn-sa-muted btn-sm"
                                                    type="button" id="brand-context-menu-0"
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end"
                                                    aria-labelledby="brand-context-menu-0">
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('admin.subcategory.edit', ['id' => $subcategory->id]) }}">Edit</a>
                                                    </li>
                                                    <li>
                                                        <hr class="dropdown-divider" />
                                                    </li>
                                                    <li>
                                                        <form
                                                            action="{{ route('admin.subcategory.delete', ['id' => $subcategory->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
