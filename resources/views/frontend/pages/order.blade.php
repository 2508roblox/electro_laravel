                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Status">
                                            ...
                                            @elseif ($item['Status'] == 'Chưa thanh toán')
                                                <h1 class="p-2 badge badge-warning text-primary text-white">
                                                    {{ $item['Status'] }}</h1>
                                        ...
                                        <td>
                                            <a style="border-radius: 10px !important"
                                                ...
                                                class="btn btn-primary rounded-0   font-weight-normal px-5 px-md-2 px-lg-5 w-100 w-md-auto">
                                                Chi tiết</a>
                                            @if ($item['Status'] == 'Chờ xác nhận')
                                                <a onclick="return comfirm('xác nhận hủy')"
                                                    style="border-radius: 10px !important"
                                                    href="{{ route('admin.order.client.cancel', ['id' => $item['ID']]) }}"
                                                    class="btn btn-danger rounded-0   font-weight-normal px-5 px-md-2 px-lg-5 w-100 w-md-auto">
                                                    Hủy đơn</a>
                                            @elseif ($item['Status'] == 'Đang giao hàng')
                                                <a style="border-radius: 10px !important"
                                                    href="{{ route('admin.order.received', ['id' => $item['ID']]) }}"
                                                    class="btn btn-success rounded-0   font-weight-normal px-5 px-md-2 px-lg-5 w-100 w-md-auto">
                                                    Đã nhận</a>
                                            @elseif ($item['Status'] == 'Chưa thanh toán')
                                                <a style="border-radius: 10px !important"
                                                    href="{{ route('admin.checkout.pay', ['id' => $item['ID']]) }}"
                                                    class="btn btn-success rounded-0 font-weight-normal px-5 px-md-2 px-lg-5 w-100 w-md-auto">Thanh
                                                    toán</a>
                                            @elseif ($item['Status'] == 'Đã xác nhận' || $item['Status'] == 'Đã thanh toán')
                                                <a onclick="return confirm('xác nhận hủy')"
                                                    style="border-radius: 10px !important"
                                                    href="{{ route('admin.order.client.cancel', ['id' => $item['ID']]) }}"
                                                    class="btn btn-danger rounded-0 font-weight-normal px-5 px-md-2 px-lg-5 w-100 w-md-auto">Hủy
                                                    đơn</a>
                                            @elseif ($item['Status'] == 'Đang giao hàng' || $item['Status'] == 'Đã thanh toán')
                                                <a style="border-radius: 10px !important"
                                                    href="{{ route('frontend.order.show', ['id' => $item['ID']]) }}"
