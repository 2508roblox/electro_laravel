                    ...
                    <div class="max-width-1100-wd">
                        ...
                        <article class="card mb-13 border-0">
                            <div class="js-slick-carousel u-slick overflow-hidden" data-pagi-classes="js-pagination u-slick__pagination u-slick__pagination--long u-slick__pagination--hover mb-0">
                                <div class="js-slide">
                                    <a href="{{ $blog->slug }}" target="_blank" class="d-block"><img class="img-fluid" src="{{ asset('../storage/images/' . $blog->image) }}" alt="Image Description"></a>
                                </div>
                                <div class="js-slide">
                                    <a href="{{ $blog->slug }}" target="_blank" class="d-block"><img class="img-fluid" src="{{ asset('../storage/images/' . $blog->image) }}" alt="Image Description"></a>
                                </div>
                            ...
                            <div class="card-body pt-5 pb-0 px-0">
                                <h4 class="mb-3"><a href="{{ $blog->slug }}" target="_blank">{{ $blog->title }}</a></h4>
                                <div class="mb-3 pb-3 border-bottom">
                                    <div class="list-group list-group-horizontal flex-wrap list-group-borderless align-items-center mx-n0dot5">
                                        <a href="{{ $blog->slug }}" target="_blank" class="mx-0dot5 text-gray-5">{{ $blog->tag }}</a>
                                        <span class="mx-2 font-size-n5 mt-1 text-gray-5"><i class="fas fa-circle"></i></span>
                                        <a href="{{ $blog->slug }}" target="_blank" class="mx-0dot5 text-gray-5">{{ $blog->date_time }}</a>
                                    </div>
                                </div>
                                <p>{{ $blog->short_description }}</p>
                                <div class="flex-horizontal-center">
                                    <a href="{{ $blog->slug }}" target="_blank" class="btn btn-soft-secondary-w mb-md-0 font-weight-normal px-5 px-md-4 px-lg-5">Read More</a>
                                </div>
                            </div>
                        </article>
                        @endforeach
