 ...
 @section('content')
     <div id="top" class="sa-app__body">
         <form id="form" action="{{ route('admin.category.store') }}" method="post" enctype="multipart/form-data">
             @csrf
                                 ...
                                 <div class="card mt-5">
                                     <div class="card-body p-5">
                                         ...
                                         <div><label for="form-category/seo-description" class="form-label">Meta
                                                 description</label>
                                             <textarea name="seo_description" id="form-category/seo-description" class="form-control" rows="2"></textarea>
