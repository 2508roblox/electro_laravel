...
<div id="top" class="sa-app__body">
    <form id="form" method="POST" action="{{route('admin.coupon.store')}}">
        @csrf
                            ...
                            <div class="card w-100">
                                <div class="card-body p-5">
                                    ...
                                    <div class="mb-4"><label class="form-check"><input type="radio"
                                                class="form-check-input" checked  name="is_active" value="active" /><span
                                ...
                                <div class="card-body p-5">
                                    <div>
                                        <label for="form-product/seo-title" class="form-label">Expire
                                            date</label><input name="expires_at" type="text"
