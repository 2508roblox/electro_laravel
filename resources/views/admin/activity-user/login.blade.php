...
@section('content')
    ...
    <div class="dropdown sa-toolbar__item"><button class="sa-toolbar-user" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" data-bs-offset="0,1" aria-expanded="false"><span class="sa-toolbar-user__avatar sa-symbol sa-symbol--shape--rounded"><img src="images/customers/customer-4-64x64.jpg" width="64" height="64" alt=""/></span><span class="sa-toolbar-user__info"><span class="sa-toolbar-user__title">{{ Auth::user()->name }}</span><span class="sa-toolbar-user__subtitle">{{ Auth::user()->email }}</span></span></button>
        <ul
            ...
            <div class="container">
                <div class="py-5">
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-auto d-flex"><a href="{{route('admin.user.create')}}" class="btn btn-primary">New user</a></div>
                    </div>
                </div>
                <div class="card">
                    <div class="p-4"><input type="text" placeholder="Start typing to search for user" class="form-control form-control--search mx-auto" id="table-search" /></div>
                    ...
                    <table class="sa-datatables-init" data-order="[[ 1, &quot;asc&quot; ]]" data-sa-search-input="#table-search">
                        <thead>
                            <tr>
                                ...
                                <th class="min-w-8x">Date Active</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="text-reset">{{$user->ip_address}}</a></td>
                                ...
                                <td><a class="text-reset">
                                    @php
                                        if ($user->email_verified_at != NULL) {
                                            echo '<div class="badge badge-sa-success" bis_skin_checked="1">Active</div>';
                                        }
                                        else {
                                ...
                                <td>
                                    <div class="dropdown"><button class="btn btn-sa-muted btn-sm" type="button" id="user-context-menu-0" data-bs-toggle="dropdown" aria-expanded="false" aria-label="More"><svg xmlns="http://www.w3.org/2000/svg" width="3" height="13" fill="currentColor"><path d="M1.5,8C0.7,8,0,7.3,0,6.5S0.7,5,1.5,5S3,5.7,3,6.5S2.3,8,1.5,8z M1.5,3C0.7,3,0,2.3,0,1.5S0.7,0,1.5,0 S3,0.7,3,1.5S2.3,3,1.5,3z M1.5,10C2.3,10,3,10.7,3,11.5S2.3,13,1.5,13S0,12.3,0,11.5S0.7,10,1.5,10z"></path></svg></button>
                                        <ul
                                            class="dropdown-menu dropdown-menu-end" aria-labelledby="user-context-menu-0">
