            ...
            <div class="sa-inbox__body">
                ...
                <div class="sa-inbox-chat">
                    <div class="sa-inbox-chat__header">
                        <div class="sa-inbox-chat__subject">[Electro: Your Order Invoice] Message sent via your Envato
                            Market profile
                            from
                            kos9</div>
                        ...
                        <div class="sa-inbox-chat__labels"><span class="badge badge-sa-primary">Invoice Email /
                    ...
                    <div class="sa-inbox-chat__list">
                        <div class="sa-inbox-chat__item sa-inbox-chat__item--expanded">
                            <div class="sa-inbox-chat__item-header">
                                ...
                                <div class="sa-inbox-chat__item-date"></div>
                            ...
                            <head>
                                ...
                                <style>
                                    ...
                                    .invoice-boxx table td {
                                        padding: 5px;
                                        vertical-align: top;
                                    }

                                    .invoice-boxx table tr td:nth-child(2) {
                                        text-align: right;
                                    }

                                    .invoice-boxx table tr.top table td {
                                        padding-bottom: 20px;
                                    }

                                    .invoice-boxx table tr.top table td.title {
                                        font-size: 45px;
                                        line-height: 45px;
                                        color: #333;
                                    }

                                    .invoice-boxx table tr.information table td {
                                        padding-bottom: 40px;
                                    }

                                    .invoice-boxx table tr.heading td {
                                        background: #eee;
                                        font-weight: bold;
                                    }

                                    .invoice-boxx table tr.details td {
                                        padding-bottom: 20px;
                                    }

                                    .invoice-boxx table tr.item td {}

                                    .invoice-boxx table tr.item.last td {}

                                    .invoice-boxx table tr.total td:nth-child(2) {
                                        font-weight: bold;
                                    }
                                    ...
                                    <table>
                                        ...
                                        @foreach ($order_items as $item)
                                            <tr style="border-bottom: 1px solid rgb(220, 220, 220)">
                                                ...
                                                <td style="text-align: end" class="sa-invoice__table-column--type--price">
                                                    ${{ $item->product_price }}.00
                                                </td>
                                                <td style="text-align: end"
                                                    class="sa-invoice__table-column--type--quantity">{{ $item->quantity }}
                                                </td>
                                        ...
                                        <tr>
                                            <td colspan="2" style="text-align: start"
                                                class="sa-invoice__table-column--type--header" colSpan="4">Subtotal
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="2" style="text-align: start"
                                                class="sa-invoice__table-column--type--header" colSpan="4">Ship (VAT
                                                1%)</td>
                                            <td class="sa-invoice__table-column--type--total">
                                        ...
                                        <tr>
                                            <td colspan="2" style="text-align: start"
                                                class="sa-invoice__table-column--type--header" colSpan="4">Discount
                                            </td>
                                        ...
                                        <tr style=" border-top: 1px solid gray">
                                            <td colspan="2" style="text-align: start"
                                                class="sa-invoice__table-column--type--header" colSpan="4">Total</td>
                                            <td class="sa-invoice__table-column--type--total">
                                                ${{ number_format($order_data['shipping_price'] + $order_data['total_amount']) }}.00
                                            </td>
                                        </tr>
                                    </table>
                                </div>
