...
@section('content')
    <div id="top" class="sa-app__body">
        <form id="form" action="{{ route('admin.color.update', ['id' => $color->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                                    ...
                                    <div class="card-body p-5">
                                        ...
                                        <div class="mb-4"><label for="form-color/slug" class="form-label">Color Code</label>
                                            <div class="input-group input-group--sa-slug"><span class="input-group-text"
                                                    ...
                                                    name="code"  value="{{$color->code}}" type="text" class="form-control"
                                                    id="form-color/slug"
                                ...
                                <div class="card w-100">
                                    <div class="card-body p-5">
                                        ...
                                        <div class="mb-4"><label class="form-check"><input type="radio"
                                                    class="form-check-input"{{$color->status == '1' ? 'checked' : ''}} name="status" checked="" value="published" /><span
                                                    class="form-check-label">Published</span></label>
                                            <label class="form-check mb-0"><input {{$color->status == '0' ? 'checked' : ''}} value="hidden" type="radio"
