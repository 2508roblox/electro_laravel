                ...
                <div class="container">
                    <div class="py-5">
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-auto d-flex"><a href="{{ route('admin.blog.create') }}"
                                    class="btn btn-primary">New blog</a></div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="p-4"><input type="text" placeholder="Start typing to search for post"
                            ...
                            <tbody>
                                ...
                                @foreach ($comments as $comment)
                                    <tr>
                                        ...
                                        <td><u><a type="button"
                                                    href="{{ route('fe.post', ['id' => $comment->blog_id]) }}"
                                                    target="_blank"
                                                    class="text-reset btn btn-primary">{{ $comment->blog_id }}</a></u></td>
                                        <td><a
                                                class="text-reset">{{ Illuminate\Support\Str::limit($comment->content, 20) }}</a>
                                        </td>
                                        ...
                                        <td><a class="text-reset">{{ $comment->created_at->format('d-m-Y H:i:s') }}</a>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                <button class="btn btn-sa-muted btn-sm" type="button"
                                                    id="blog-context-menu-0" data-bs-toggle="dropdown"
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end"
                                                    aria-labelledby="user-context-menu-0">
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('admin.blog.comment.edit', ['id' => $comment->id]) }}">Edit</a>
                                                    </li>
                                                    <li>
                                                        <form
                                                            action="{{ route('admin.blog.comment.delete', ['id' => $comment->id]) }}"
                                                            met hod="POST">
                                                            @csrf
                                                            @method('DELETE')
