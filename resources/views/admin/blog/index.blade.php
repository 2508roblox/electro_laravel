            ...
            <div class="container">
                <div class="py-5">
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-auto d-flex"><a href="{{route('admin.blog.create')}}" class="btn btn-primary">New blog</a></div>
                    </div>
                </div>
                <div class="card">
                    <div class="p-4"><input type="text" placeholder="Start typing to search for post" class="form-control form-control--search mx-auto" id="table-search" /></div>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="user-context-menu-0">
                                            ...
                                            <li>
                                                <form action="{{route('admin.user.delete', ['id' => $blog->id])}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
