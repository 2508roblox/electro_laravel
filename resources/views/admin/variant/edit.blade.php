...
@section('content')
    <div id="top" class="sa-app__body">
        <form id="form" action="{{ route('admin.variants.update', ['id' => $variant->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
                                ...
                                <div class="card">
                                    <div class="card-body p-5">
                                        ...
                                        <div class="mb-4"><label for="form-variants/name" class="form-label">Name</label>
                                            <input name="value" type="text" class="form-control" value="{{$variant->value}}"
