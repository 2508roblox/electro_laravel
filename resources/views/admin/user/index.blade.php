                ...
                <div class="container">
                    <div class="py-5">
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-auto d-flex"><a href="{{ route('admin.user.create') }}"
                                    class="btn btn-primary">New user</a></div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="p-4"><input type="text" placeholder="Start typing to search for user"
                            ...
                            <tbody>
                                ...
                                @forelse ($users as $user)
                                    <tr>
                                        ...
                                        <td><a class="text-reset">{{ $user->role_as == '1' ? 'Admin' : 'Customer' }}</a>
                                        </td>
                                        <td><a
                                                class="text-reset">{{ optional($user->wallet)->balance ? number_format($user->wallet->balance, 0, ',', '.') . 'đ' : 'N/A' }}</a>
                                        </td>
                                        ...
                                        <td>
                                            <div class="dropdown"><button class="btn btn-sa-muted btn-sm" type="button"
                                                    id="user-context-menu-0" data-bs-toggle="dropdown"
