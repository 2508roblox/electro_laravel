                            ...
                            <tbody>
                                @forelse ($brands as  $brand)
                                    <tr>
                                        ...
                                        <td><a href="app-brand.html" class="text-reset">{{ $brand->category_id }}</a></td>
                                        <td>3</td>
                                        <td>
                                            <div class="badge badge-sa-success">
                                                {{ $brand->status == '1' ? 'Publish' : 'Hidden' }}</div>
                                        </td>
                                        <td>
                                            <div class="dropdown"><button class="btn btn-sa-muted btn-sm" type="button"
                                                    id="brand-context-menu-0" data-bs-toggle="dropdown"
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end"
                                                    ...
                                                    <li><a class="dropdown-item"
                                                            href="{{ route('admin.brand.edit', ['id' => $brand->id]) }}">Edit</a>
                                                    </li>
                                                    <li>
                                                        <hr class="dropdown-divider" />
                                                    </li>
