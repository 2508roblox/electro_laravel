            ...
            <div class="container container--max--xl">
                <div class="py-5">
                    <div class="row g-4 align-items-center">
                        <div class="col">
                            <nav class="mb-2" aria-label="breadcrumb">
                                <ol class="breadcrumb breadcrumb-sa-simple">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{ route('admin.order.list', ['id' => 1]) }}">Danh
                                            sách hóa đơn</a></li>
                        ...
                        <div class="col-auto d-flex"><a href="{{ route('admin.order.list') }}"
                                class="btn btn-secondary me-3">Back</a><a
                                href="{{ route('admin.invoice.view', ['id' => $order['ID']]) }}"
                                class="ml-2 btn btn-success">View Invoice</a>
                            <a style="margin-left: .7rem"
                                href="{{ route('admin.invoice.download', ['id' => $order['ID']]) }}"
                                class="btn btn-primary">Download Invoice</a>
                            <a style="  margin-left: 1rem" href="{{ route('admin.invoice.mail', ['id' => $order['ID']]) }}"
                                class="btn btn-info ">
                                Gửi mail
                            </a>
                        </div>
                    ...
                    <div class="sa-page-meta__body">
                        <div class="sa-page-meta__list">
                            ...
                            <div class="sa-page-meta__item d-flex align-items-center fs-6"><span
                                    class="badge badge-sa-success me-2">{{ $order['Method'] }}</span><span
                                    class="badge
                            @php
if ($order['Status'] =='Chờ xác nhận') {
                            ...
                            me-2">{{ $order['Status'] }}</span>
                            </div>

                            <a href="{{ route('admin.order.update', ['id' => $order['ID']]) }}" class="  rounded-circle">
                                <svg style="fill: green" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30"
                ...
                <div class="sa-entity-layout"
                    ...
                    <div class="sa-entity-layout__body">
                                    ...
                                    <table class="sa-table">
                                        <tbody>
                                            ...
                                            @forelse ($order_items as $item)
                                                <tr>
                                                    <td class="min-w-20x d-flex" style="flex-direction: row">
                                                        <div class="d-flex align-items-center"><img
                                                                ...
                                                                alt="" /><a href="app-product.html"
                                                                class="text-reset">@php
                                                            ...
                                                            <div class=""
                                                                style="background: #{{ $item->color_code }}; margin-left: 1rem; border-radius:100% ; height: 10px; width:10px;">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="text-end">
                                                        <div class="sa-price"><span class="sa-price__symbol">$</span><span
                                                                class="sa-price__integer">{{ number_format($item['price']) }}</span><span
                                                                class="sa-price__decimal">.00</span></div>
                                                    </td>
                                                    <td class="text-end" style="width: 100px">× {{ $item['quantity'] }}
                                                    </td>
                                                    <td class="text-end">
                                                        <div class="sa-price"><span class="sa-price__symbol">$</span><span
                                                ...
                                                @php
                                                    $subtotal += $item->quantity * $item->price; // Tính tổng giá trị của mỗi mục và cộng vào subtotal
                                        ...
                                        <tbody class="sa-table__group">
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="sa-price"><span class="sa-price__symbol">$</span><span
                                                            class="sa-price__integer">{{ number_format($subtotal) }}</span><span
                                                            class="sa-price__decimal">.00</span></div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="sa-price"><span class="sa-price__symbol">$</span><span
                                                            class="sa-price__integer">{{ number_format($order_data['shipping_price']) }}</span><span
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="sa-price"> <span
                                                            class="sa-price__decimal">-${{number_format($order_data['discount']) }}.00</span></div>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="sa-price"><span class="sa-price__symbol">$</span><span
                                                            class="sa-price__integer">{{ number_format($order_data['total_amount']) }}</span><span
                                                            class="sa-price__decimal">.00</span></div>
                                                </td>
                                            </tr>
                                        </tbody>
                        ...
                        <div class="sa-entity-layout__sidebar">
                            ...
                            <div class="card mt-5">
                                <div class="card-body d-flex align-items-center justify-content-between pb-0 pt-4">
                                    <h2 class="fs-exact-16 mb-0">Địa chỉ nhận hàng</h2><a href="#"
                                        class="fs-exact-14">Edit</a>
                                </div>
                                <div class="card-body pt-4 fs-exact-14">{{ $order['Name'] }}<br />Random
