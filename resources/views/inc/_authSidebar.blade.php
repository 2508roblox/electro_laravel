<aside id="sidebarContent" class="u-sidebar u-sidebar__lg u-unfold--css-animation fadeInRight"
    aria-labelledby="sidebarNavToggler" style="animation-duration: 500ms; right: 0px;">
            ...
            <div class="js-scrollbar u-header-sidebar__footer-offset pb-3 mCustomScrollbar _mCS_2 mCS-autoHide mCS_no_scrollbar"
                ...
                <div id="mCSB_2" class="mCustomScrollBox mCS-minimal-dark mCSB_vertical mCSB_outside"
                    ...
                    <div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y"
                        ...
                        <!-- Content -->
                        <div class="js-scrollbar u-sidebar__body mCustomScrollbar _mCS_3 mCS-autoHide mCS_no_scrollbar"
                            style="position: relative; overflow: visible;">
                                    ...
                                    <div class="u-sidebar__content u-header-sidebar__content">
                                        ...
                                        <div id="forgotPassword" style="display: none; opacity: 0;"
                                            ...
                                            <header class="text-center mb-7">
                                                ...
                                                <p>Enter your email address and an email with instructions will be sent
                                                    to you.</p>
                                            </header>
                                            <!-- End Title -->
