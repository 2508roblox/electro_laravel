! function(t, e) {
    ...
    st.PipsMode = void 0, (z = st.PipsMode || (st.PipsMode = {})).Range = "range", z.Steps = "steps", z.Positions = "positions", z.Count = "count", z.Values = "values", st.PipsType = void 0, (z = st.PipsType || (st.PipsType = {}))[z.None = -1] = "None", z[z.NoValue = 0] = "NoValue", z[z.LargeValue = 1] = "LargeValue", z[z.SmallValue = 2] = "SmallValue";
    ...
    function V(t, e) {
        ...
        var r = 0 <= e.indexOf("tap"),
            ...
            o = 0 <= e.indexOf("snap"),
            s = 0 <= e.indexOf("hover"),
            e = 0 <= e.indexOf("unconstrained");
        if (i) {
            if (2 !== t.handles) throw new Error("noUiSlider: 'fixed' behaviour must be used with 2 handles");
            E(t, t.start[1] - t.start[0])
        }
        if (e && (t.margin || t.limit)) throw new Error("noUiSlider: 'unconstrained' behaviour cannot be used with margin or limit");
        t.events = {
            tap: r || o,
            drag: n,
            fixed: i,
    ...
    function T(t, f, o) {
        var i, a, s, n, l, e, u, c = window.navigator.pointerEnabled ? {
                start: "pointerdown",
                move: "pointermove",
                end: "pointerup"
        ...
        function C(t, e) {
            var r = P(t, f.cssClasses.origin),
                t = P(r, f.cssClasses.handle);
            return P(t, f.cssClasses.touchArea), t.setAttribute("data-handle", String(e)), f.keyboardSupport && (t.setAttribute("tabindex", "0"), t.addEventListener("keydown", function(t) {
                return function(t, e) {
                    if (V() || k(e)) return !1;
                    var r = ["Left", "Right"],
                        n = ["Down", "Up"],
            ...
            })), t.setAttribute("role", "slider"), t.setAttribute("aria-orientation", f.ort ? "vertical" : "horizontal"), 0 === e ? dt(t, f.cssClasses.handleLower) : e === f.handles - 1 && dt(t, f.cssClasses.handleUpper), r
        }
        ...
        function M() {
            l && (I("update" + gt.tooltips), l.forEach(function(t) {
                t && at(t)
            }), l = null)
        }

        function U() {
            M(), l = a.map(r), Y("update" + gt.tooltips, function(t, e, r) {
                l && f.tooltips && !1 !== l[e] && (t = t[e], !0 !== f.tooltips[e] && (t = f.tooltips[e].to(r[e])), l[e].innerHTML = t)
            })
        }
        ...
        function D(d) {
            var h = function(t) {
                    ...
                    if (t.mode !== st.PipsMode.Count) return t.mode === st.PipsMode.Positions ? A(t.values, t.stepped) : t.mode === st.PipsMode.Values ? t.stepped ? t.values.map(function(t) {
                        return S.fromStepping(S.getStep(S.toStepping(t)))
                    }) : t.values : [];
                    if (t.values < 2) throw new Error("noUiSlider: 'values' (>= 2) required for mode 'count'.");
                    for (var e = t.values - 1, r = 100 / e, n = []; e--;) n[e] = e * r;
                    return n.push(100), A(n, t.stepped)
                }(d),
                m = {},
                t = S.xVal[0],
        ...
        function T(t) {
            ...
            return n = d.appendChild(L(e, r, t))
        }
        ...
        function B(t) {
            ...
            !1 !== r && (f.events.snap || ct(d, f.cssClasses.tap, f.animationDuration), Z(r, e, !0, !0), Q(), W("slide", r, !0), W("update", r, !0), W("change", r, !0), W("set", r, !0), f.events.snap && q(t, {
                handleNumbers: [r]
            }))
        }
        ...
        function tt(t) {
            var e, r;
            s[t] && (r = 100, e = "translate(" + G(K(e = (e = 0) !== t ? m[t - 1] : e, r = (r = t !== s.length - 1 ? m[t] : r) - e) + "%", "0") + ")", r = "scale(" + G(r / 100, "1") + ")", s[t].style[f.transformRule] = e + " " + r)
        }
        ...
        function rt(t, e, r) {
            ...
            for (var i = 1 === g.length ? 0 : 1; i < g.length; ++i) g.forEach(function(t) {
                Z(t, m[t], !0, !0, r)
            });
        ...
        dt(e = d, f.cssClasses.target), 0 === f.dir ? dt(e, f.cssClasses.ltr) : dt(e, f.cssClasses.rtl), 0 === f.ort ? dt(e, f.cssClasses.horizontal) : dt(e, f.cssClasses.vertical), dt(e, "rtl" === getComputedStyle(e).direction ? f.cssClasses.textDirectionRtl : f.cssClasses.textDirectionLtr), i = P(e, f.cssClasses.base),
            function(t, e) {
                ...
                a = [], (s = []).push(N(r, t[0]));
                for (var n = 0; n < f.handles; n++) a.push(C(e, n)), g[n] = n, s.push(N(r, t[n + 1]))
            }(f.connect, i), (u = f.events).fixed || a.forEach(function(t, e) {
                z(c.start, t.children[0], q, {
                    handleNumbers: [e]
                })
            }), u.tap && z(c.start, i, B, {}), u.hover && z(c.move, i, X, {
                hover: !0
            }), u.drag && s.forEach(function(e, r) {
                var n, i, t;
                !1 !== e && 0 !== r && r !== s.length - 1 && (n = a[r - 1], i = a[r], t = [e], dt(e, f.cssClasses.draggable), u.fixed && (t.push(n.children[0]), t.push(i.children[0])), t.forEach(function(t) {
                    z(c.start, t, q, {
                        handles: [n, i],
                        handleNumbers: [r - 1, r],
                        connect: e
            ...
            }), rt(f.start), f.pips && T(f.pips), f.tooltips && U(), I("update" + gt.aria), Y("update" + gt.aria, function(t, e, o, r, s) {
                g.forEach(function(t) {
                    var e = a[t],
                        r = $(m, t, 0, !0, !0, !0),
                        n = $(m, t, 100, !0, !0, !0),
        ...
        var ot = {
            ...
            updateOptions: function(e, t) {
                ...
                n.forEach(function(t) {
                    void 0 !== e[t] && (f[t] = i[t])
                }), S = i.spectrum, f.margin = i.margin, f.limit = i.limit, f.padding = i.padding, f.pips ? T(f.pips) : O(), (f.tooltips ? U : M)(), m = [], rt(lt(e.start) ? e.start : r, t)
            },
            target: d,
            removePips: O,
            removeTooltips: M,
    ...
    st.create = j, st.cssClasses = p, st.default = z, Object.defineProperty(st, "__esModule", {
        value: !0
    })
});